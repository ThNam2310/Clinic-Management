                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Thêm Dược Phẩm</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4" class="col-form-label">Số Lượng
                                                    (Thùng)</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputState" class="col-form-label">Danh Mục Dược
                                                    Phẩm</label>
                                        ...
                                        <div class="form-group">
                                            <label for="inputPassword4" class="col-form-label">Mã Dược
                                                Phẩm(EAN-8)</label>
                                            <?php
                                            $length = 10;
                                            ...
                                            <input required="required" type="text" value="<?php echo $phar_bcode; ?>"
                                                name="phar_bcode" class="form-control" id="inputPassword4">
                                        </div>
                                        ...
                                        <button type="submit" name="add_pharmaceutical"
                                            class="ladda-button btn btn-success" data-style="expand-right">Thêm Dược
                                            Phẩm</button>
