...
if (isset($_POST['update_profile'])) {
    ...
    $stmt = $mysqli->prepare("SELECT doc_fname, doc_lname, doc_email, doc_dpic FROM his_docs WHERE doc_id = ?");
    $stmt->bind_param("s", $doc_id);
    $stmt->execute();
    $stmt->bind_result($current_fname, $current_lname, $current_email, $current_dpic);
    $stmt->fetch();
    $stmt->close();

    // Sử dụng giá trị mới nếu có, nếu không giữ nguyên
    $doc_fname = !empty($_POST['doc_fname']) ? $_POST['doc_fname'] : $current_fname;
    $doc_lname = !empty($_POST['doc_lname']) ? $_POST['doc_lname'] : $current_lname;
    $doc_email = !empty($_POST['doc_email']) ? $_POST['doc_email'] : $current_email;
    ...
    if (!empty($_FILES["doc_dpic"]["name"])) {
        ...
        $doc_dpic = $current_dpic;
    }
    $full_name = $doc_fname . ' ' . $doc_lname;
    ...
    if ($stmt) {
        ...
        //echo "doc_number từ session là: " . $doc_number; // Kiểm tra giá trị

        $query2 = "UPDATE his_payrolls SET pay_doc_name=? WHERE pay_doc_number=?";
        $stmt2 = $mysqli->prepare($query2);
        $stmt2->bind_param('ss', $full_name, $doc_number);
        $stmt2->execute();

        if ($stmt2) {
            $success = "Profile & Payroll name updated";
        } else {
            $err = "Updated profile but failed to update payroll name.";
        }
    } else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"> Thông tin của bác sĩ <?php echo $row->doc_fname; ?>
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Chức vụ:</strong> <span
                                                class="ml-2"><?php echo $row->doc_dept; ?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Mã nhân viên:</strong> <span
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="doc_fname" class="form-control"
                                                                id="firstname" placeholder="<?php echo $row->doc_fname; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="doc_lname" class="form-control"
                                                                id="lastname" placeholder="<?php echo $row->doc_lname; ?>">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="doc_email" class="form-control"
                                                                id="useremail" placeholder="<?php echo $row->doc_email; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="useremail">Hình ảnh</label>
                                            ...
                                            <form method="post">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" name="doc_pwd"
                                                                id="lastname" placeholder="Ấn Mật Khẩu Mới">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                                ...
                                                <div class="text-right">
                                                    <button type="submit" name="update_pwd"
                                                        class="btn btn-success waves-effect waves-light mt-2"><i
                                                            class="mdi mdi-content-save"></i> Sửa Mật Khẩu</button>
                                                </div>
                                            </form>
                                        </div>
