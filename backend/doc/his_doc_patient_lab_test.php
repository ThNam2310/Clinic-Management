                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Xét Nghiệm Bệnh Nhân</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_add_single_lab_test.php?pat_number=<?php echo $row->pat_number; ?>"
                                                            class="badge badge-warning"><i class="mdi mdi-beaker "></i> Thêm
                                                            Xét Nghiệm</a>
                                                    </td>
                                                </tr>
                                            <?php $cnt = $cnt + 1;
