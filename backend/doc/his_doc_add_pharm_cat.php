                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Thêm Danh Mục Dược Phẩm</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Thêm Danh Mục Dược Phẩm</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <form method="post">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4" class="col-form-label">Tên Danh Mục Dược
                                                    Phẩm</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputState" class="col-form-label">Nhà Cung Cấp Dược
                                                    Phẩm</label>
                                        ...
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Miêu tả Danh Mục Dược
                                                Phẩm</label>
                                            <textarea required="required" type="text" class="form-control"
                                                name="pharm_cat_desc" id="editor"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Nhà cung cấp</label>
                                            <textarea required="required" type="text" class="form-control"
                                                name="pharm_cat_desc" id="editor"></textarea>
                                        </div>
