                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Kho hàng</a></li>
                                        <li class="breadcrumb-item active">Thiệt Bị | Kiểm Kê Tài Sản</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Thiết Bị #<?php echo $row->eqp_code;?> Chi Tiết</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7">
                                        <div class="pl-xl-3 mt-3 mt-xl-0">
                                            ...
                                            <hr>
                                            <h4 class="text-danger">Nhà Cung Cấp: <?php echo $row->eqp_vendor;?>
                                            </h4>
                                            <hr>
                                            <h4 class="text-danger">Mã Thiết Bị: <?php echo $row->eqp_code;?></h4>
                                            <hr>
                                            <h4 class="text-danger">Số Lượng Hiện Có : <?php echo $row->eqp_qty;?>
                                            </h4>
                                            <hr>
                                            <h4 class="text-danger">Trạng Thái : <?php echo $row->eqp_status;?>
                                            </h4>
                                            <hr>
