                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Phòng Xét Nghiệm</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Thêm Xét Nghiệm</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <button type="submit" name="add_patient_lab_test" class="ladda-button btn btn-success" data-style="expand-right">Thêm Xét Nghiệm</button>
