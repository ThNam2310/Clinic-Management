                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Tình Trạng Bệnh Nhân <?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?> </h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Bệnh</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputEmail4" class="col-form-label">Nhiệt Độ Cơ Thể °C</label>
                                                        <input type="text" required="required"  name="vit_bodytemp"class="form-control" id="inputEmail4" placeholder="°C">
                                                    </div>

                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">Nhịp Tim BPM</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">Nhịp Hô Hấp bpm</label>
                                                        <input required="required" type="text"  name="vit_resprate"  class="form-control"  id="inputPassword4" placeholder="Breathes Per Minute">
                                                    </div>

                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">Nồng Độ Máu mmHg</label>
                                                        <input required="required" type="text"  name="vit_bloodpress"  class="form-control"  id="inputPassword4" placeholder="mmHg">
                                                    </div>

                                                </div>

                                                <button type="submit" name="add_patient_vitals" class="ladda-button btn btn-success" data-style="expand-right">Thêm Tình Trạng Bệnh Nhân</button>
