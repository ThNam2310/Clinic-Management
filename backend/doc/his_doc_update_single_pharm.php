                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Quản Lí Dược Phẩm</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Số Lượng(Thùng)</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                        <label for="inputState" class="col-form-label">Danh Mục Dược Phẩm</label>
                                            ...
                                            <button type="submit" name="update_pharmaceutical" class="ladda-button btn btn-warning" data-style="expand-right">Cập Nhật</button>
