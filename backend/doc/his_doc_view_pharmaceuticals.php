                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Hiệu Thuốc</a>
                                        </li>
                                        <li class="breadcrumb-item active">Thông Tin Dược Phẩm</li>
                                    </ol>
                                </div>
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Mã dược phẩm</th>
                                                <th data-hide="phone">Nhà cung câp</th>
                                                <th data-hide="phone">Danh mục dược phẩm</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_view_single_pharm.php?phar_bcode=<?php echo $row->phar_bcode; ?>"
                                                            class="badge badge-success"><i class="far fa-eye "></i> Hiện</a>
                                                    </td>
                                                </tr>
                                            <?php $cnt = $cnt + 1;
                                            } ?>
