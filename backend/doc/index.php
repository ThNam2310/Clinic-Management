                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method='post'>
                                ...
                                <div class="form-group mb-3">
                                    <label for="emailaddress">Mã Bác Sĩ</label>
                                    <input class="form-control" name="doc_number" type="text" id="emailaddress"
                                        required="" placeholder="Nhập Mã">
                                </div>
                                ...
                                <div class="form-group mb-0 text-center">
                                    <button class="btn btn-success btn-block" name="doc_login" type="submit"> Đăng Nhập
                                    </button>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p> <a href="his_doc_reset_pwd.php" class="text-white-50 ml-1">Quên Mật Khẩu?</a></p>
