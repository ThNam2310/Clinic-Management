                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Thông Tin Danh Mục Dược Phẩm</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Danh Mục Dược Phẩm</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                            ...
                                            */
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_view_single_pharm_category.php?pharm_cat_id=<?php echo $row->pharm_cat_id; ?>"
                                                            class="badge badge-success"><i class="mdi mdi-eye"></i> Hiện</a>
                                                    </td>
                                                </tr>
                                            <?php $cnt = $cnt + 1;
                                            } ?>
