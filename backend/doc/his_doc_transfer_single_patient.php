                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Quản lý bệnh Nhân</a>
                                        </li>
                                        <li class="breadcrumb-item active">Chuyển Bệnh Viện</li>
                                    </ol>
                                </div>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Bệnh viện tiếp nhận
                                                        tuyến trên</label>
                                                    <input type="text" required="required" name="t_hospital"
                                                        class="form-control" id="inputEmail4"
                                                        placeholder="Tên bệnh viện tiếp nhận">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Ngày chuyển
                                                        viện</label>
                                                    <input required="required" type="date" name="t_date"
                                                        class="form-control" id="inputPassword4" placeholder="Ngày chuyển">
                                                </div>
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputPassword4" class="col-form-label">Mã số bệnh
                                                        nhân</label>
                                                    </label>
                                            ...
                                            <div class="form-group" style="display:none">
                                                <label for="inputAddress" class="col-form-label">Trạng thái chuyển
                                                    viện</label>
                                            ...
                                            <button type="submit" name="transfer_patient"
                                                class="ladda-button btn btn-success" data-style="expand-right">Chuyển
                                                viện</button>
