            ...
            <div class="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Thiết bị | Kiểm kê tài sản</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="header-title">Kho Thiết Bị</h4>
                                <div class="mb-2">
                                    <div class="row">
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Mã Thiết Bị</th>
                                                <th data-hide="phone">Nhà Cung Cấp</th>
                                                <th data-hide="phone">Phòng Thiết Bị</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_eqp.php?eqp_code=<?php echo $row->eqp_code; ?>"
