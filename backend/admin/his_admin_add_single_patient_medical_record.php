...
if (isset($_POST['add_patient_mdr'])) {
    ...
    if ($stmt) {
        $success = "Đã thêm hồ sơ bệnh án của bệnh nhân thành công.";
    } else {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Tuổi bệnh
                                                        nhân</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Địa chỉ bệnh
                                                        nhân</label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Chẩn đoán bệnh
                                                        lý</label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                ...
                                                <input type="text" name="mdr_number" value="<?php echo $pres_no; ?>"
                                        ...
                                        ?>
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Đơn thuốc của bệnh
                                                    nhân</label>
                                                <textarea required="required" type="text" class="form-control"
                                                    name="mdr_pat_prescr"
                                                    id="editor"><?php echo $row->pres_ins; ?> </textarea>
                                            </div>
                                        <?php } ?>

                                        <button type="submit" name="add_patient_mdr"
                                            class="ladda-button btn btn-primary" data-style="expand-right">Thêm hồ sơ
                                            bệnh án bệnh nhân</button>
