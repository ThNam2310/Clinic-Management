                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Ghi Nhận Chỉ Số Lâm Sàng</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_add_single_patient_vitals.php?pat_number=<?php echo $row->pat_number; ?>"
                                                            class="badge badge-success"><i class="mdi mdi-beaker "></i> Ghi
