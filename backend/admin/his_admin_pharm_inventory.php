            ...
            <div class="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Kho dược</a></li>
                                        <li class="breadcrumb-item active">Danh mục dược phẩm</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="header-title">Kho Dược Phẩm</h4>
                                <div class="mb-2">
                                    <div class="row">
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Số Lượng Tồn Kho</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_pharm.php?phar_bcode=<?php echo $row->phar_bcode; ?>"
