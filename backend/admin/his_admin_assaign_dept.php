                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Phân công khoa</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline" >
                                                ...
                                                <div class="form-group">
                                                    <input id="demo-foo-search" type="text" placeholder="Tìm kiến" class="form-control form-control-sm" autocomplete="on">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_assaign_single_employee.php?doc_number=<?php echo $row->doc_number;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Phân công phòng ban</a>
                                                    </td>
                                                </tr>
