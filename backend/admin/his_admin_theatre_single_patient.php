	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Đã thêm bệnh nhân phẫu thuật thành công.";
			}
			else {
                ...
                <div class="container-fluid">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Phẫu thuật | Phòng
                                                mổ</a></li>
                                        <li class="breadcrumb-item active">Thêm bệnh nhân phẫu thuật</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Thêm thông tin bệnh nhân phẫu thuật</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Điền vào các trường</h4>
                                    <!--Add Patient Form-->
                                    <form method="post">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4" class="col-form-label">Bệnh lý/chẩn
                                                    đoán</label>
                                                <input readonly required="required" type="text"
                                                    value="<?php echo $row->pat_ailment;?>" name="s_pat_ailment"
                                                    class="form-control" id="inputPassword4"
                                                    placeholder="Bệnh lý/chẩn đoán">
                                            </div>
                                        </div>

                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4" class="col-form-label">Mã số</label>
                                                <input readonly type="text" required="required"
                                                    value="<?php echo $row->pat_number;?>" name="s_pat_number"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="inputState" required="required" name="s_doc"
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                    ?>
                                                    <option><?php echo $row->doc_fname;?> <?php echo $row->doc_lname;?>
                                                    </option>
                                            ...
                                            <div class="form-group col-md-6" style="display:none">
                                                <label for="inputPassword4" class="col-form-label">Tình trạng phẫu
                                                    thuật</label>
                                                <input required="required" type="text" value="Undergoing"
                                                    name="s_pat_status" class="form-control" id="inputPassword4"
                                                    placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                <?php 
                                                    ...
                                                    ?>
                                                <label for="inputZip" class="col-form-label">Mã hồ sơ phẫu thuật</label>
                                                <input type="text" name="s_number" value="<?php echo $s_number;?>"
