                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Họ và tên nhân viên</th>
                                                <th data-hide="phone">Mã nhân viên</th>
                                                <th data-hide="phone">Email</th>
                                                <th data-hide="phone">Khoa/Phòng ban</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_employee.php?doc_id=<?php echo $row->doc_id; ?>&&doc_number=<?php echo $row->doc_number; ?>" class="badge badge-success"><i class="mdi mdi-eye"></i> Xem</a></td>
                                                </tr>
