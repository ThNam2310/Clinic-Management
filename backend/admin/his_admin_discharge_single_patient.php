                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Xuất viện</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Xuất viện cho bệnh nhân</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required="required" value="<?php echo $row->pat_fname;?>" name="pat_fname" class="form-control" id="inputEmail4" placeholder="Họ">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Tên</label>
                                                    <input required="required" type="text" value="<?php echo $row->pat_lname;?>" name="pat_lname" class="form-control"  id="inputPassword4" placeholder="Tên">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->pat_age;?>" name="pat_age" class="form-control"  id="inputPassword4" placeholder="Tuổi của bệnh nhân">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputCity" class="col-form-label">Trạng thái xuất viện</label>
                                                    <input required="required" type="text" name="pat_discharge_status" value="Đã xuất viện" class="form-control" id="inputCity">
                                                </div>
                                            ...
                                            <button type="submit" name="discharge_patient" class="ladda-button btn btn-success" data-style="expand-right">Xác nhận xuất viện</button>
