                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Đặt lại mật khẩu</a></li>
                                            <li class="breadcrumb-item active">Quản lý </li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Cập nhật chi tiết mật khẩu nhân viên</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Mật khẩu mới</label>
                                                    <input required="required"  type="text" value="<?php echo $row->pwd;?>"  name="doc_pwd" class="form-control" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputCity" class="col-form-label">Trạng thái yêu cầu</label>
                                                    <input required="required"  type="text" value="Reset"  name="status" class="form-control" id="inputCity">
                                                </div>  
                                                
                                            </div>                                            

                                            <button type="submit" name="update_doc" class="ladda-button btn btn-success" data-style="expand-right">Cập nhật mật khẩu</button>
