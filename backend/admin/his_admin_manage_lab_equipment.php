                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Quản lý thiết bị phòng xét nghiệm</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Quản lý Thiết bị Phòng Xét nghiệm</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <tbody>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                            $ret = "SELECT * FROM  his_equipments WHERE eqp_dept = 'Phòng xét nghiệm' ORDER BY RAND() ";
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_admin_manage_lab_equipment.php?delete_eqp=<?php echo $row->eqp_code; ?>"
