	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_lab_result']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Đã cập nhật kết quả xét nghiệm cận lâm sàng của bệnh nhân thành công";
			}
			else {
				$err = "Vui lòng thử lại hoặc liên hệ quản trị hệ thống";
			}
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Phòng xét nghiệm</a></li>
                                                <li class="breadcrumb-item active">Thêm kết quả xét nghiệm</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Thêm kết quả xét nghiệm</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Các xét nghiệm cận lâm sàng</label>
                                                        <textarea required="required"  type="text" class="form-control" name="lab_pat_tests" id="editor"><?php echo $row->lab_pat_tests;?></textarea>
                                                </div>

                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Kết quả xét nghiệm cận lâm sàng</label>
                                                        <textarea required="required"   type="text" class="form-control" name="lab_pat_results" id="editor1"></textarea>
                                                </div>

                                                <button type="submit" name="add_patient_lab_result" class="ladda-button btn btn-success" data-style="expand-right">Thêm kết quả xét nghiệm</button>
