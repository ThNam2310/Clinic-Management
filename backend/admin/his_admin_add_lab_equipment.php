	...
	include('assets/inc/config.php');
        ...
        
        {
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Đã bổ sung thiết bị phòng thí nghiệm";
			}
			else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Phòng thí nghiệm</a></li>
                                            <li class="breadcrumb-item active">Thêm thiết bị</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Thêm thiết bị phòng thí nghiệm</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4" style="display:none">
                                                    ...
                                                    <input required="required" type="text" value="Phòng xét nghiệm" name="eqp_dept" class="form-control"  id="inputPassword4">
                                                </div>
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputPassword4" class="col-form-label">Trạng thái thiết bị</label>
