            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Trang chính của hệ thống quản lý phòng khám</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            $result = "SELECT count(*) FROM his_patients WHERE pat_type = 'Ngoại Trú' ";
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Ngoại Trú</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            $result = "SELECT count(*) FROM his_patients WHERE pat_type = 'Nội Trú' ";
                                            $stmt = $mysqli->prepare($result);
                                            $stmt->execute();
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Nội Trú</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Nhân viên phòng khám</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Trang thiết bị</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-3">Nhân viên phòng khám</h4>
    ...
    <div class="right-bar">
        ...
        <div class="slimscroll-menu">
            ...
            <div class="user-box">
                ...
                <p class="text-muted mb-0"><small>Quản lý hành chính</small></p>
            </div>

            <!-- Settings -->
            <hr class="mt-0" />
            <h5 class="pl-3">Cài đặt cơ bản</h5>
            <hr class="mb-0" />
            ...
            <!-- Timeline -->
            <hr class="mt-0" />
            <h5 class="px-3">Tin nhắn <span class="float-right badge badge-pill badge-danger">25</span></h5>
            <hr class="mb-0" />
            <div class="p-3">
                <div class="inbox-widget">
                    <div class="inbox-item">
                        ...
                        <p class="inbox-item-text">Tôi đã hoàn thành nó! Hẹn gặp lại các bạn...</p>
                    </div>
                    <div class="inbox-item">
                    ...
                    <div class="inbox-item">
                        ...
                        <p class="inbox-item-text">Chào! Ở đó tôi có sẵn...</p>
                    </div>
                    <div class="inbox-item">
