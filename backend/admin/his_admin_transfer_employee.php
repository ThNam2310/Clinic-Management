                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Chuyển công tác nhân viên</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Chuyển công tác nhân viên</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Họ tên nhân viên (bác sĩ)</th>
                                                <th data-hide="phone">Mã số nhân viên</th>
                                                <th data-hide="phone">Khoa/phòng ban hiện tại</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_transfer_single_employee.php?doc_number=<?php echo $row->doc_number;?>" class="badge badge-warning"><i class="mdi mdi-check-box-outline "></i> Chuyển giao nhân viên</a>
                                                    </td>
                                                </tr>
