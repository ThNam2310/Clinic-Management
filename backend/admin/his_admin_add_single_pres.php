	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_presc']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Đã thêm đơn thuốc của bệnh nhân.";
			}
			else {
				$err = "Vui lòng thử lại hoặc liên hệ kỹ thuật viên.";
			}
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Thêm đơn thuốc cho bệnh nhân</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required="required" readonly name="pres_pat_name" value="<?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?>" class="form-control" id="inputEmail4" placeholder="Tên bệnh nhân">
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Tuổi bệnh nhân</label>
                                                        <input required="required" type="text" readonly name="pres_pat_age" value="<?php echo $row->pat_age;?>" class="form-control"  id="inputPassword4" placeholder="Tuổi bệnh nhân">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" required="required" readonly name="pres_pat_number" value="<?php echo $row->pat_number;?>" class="form-control" id="inputEmail4" placeholder="Mã số bệnh nhân">
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Địa chỉ bệnh nhân</label>
                                                        <input required="required" type="text" readonly name="pres_pat_addr" value="<?php echo $row->pat_addr;?>" class="form-control"  id="inputPassword4" placeholder="Địa chỉ bệnh nhân">
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Loại bệnh nhân</label>
                                                        <input required="required" readonly type="text" name="pres_pat_type" value="<?php echo $row->pat_type;?>" class="form-control"  id="inputPassword4" placeholder="Loại bệnh nhân">
                                                    </div>

                                                </div>

                                                <div class="form-group ">
                                                        <label for="inputCity" class="col-form-label">Chuẩn đoán bệnh</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Mã số đơn thuốc</label>
                                                ...
                                                <button type="submit" name="add_patient_presc" class="ladda-button btn btn-primary" data-style="expand-right">Thêm đơn thuốc cho bệnh nhân</button>
