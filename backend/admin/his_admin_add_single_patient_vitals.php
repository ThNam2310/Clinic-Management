...
if (isset($_POST['add_patient_vitals'])) {
    ...
    if ($stmt) {
        $success = "Đã thêm dấu hiệu sinh tồn của bệnh nhân thành công.";
    } else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Phòng xét nghiệm</a>
                                            </li>
                                            <li class="breadcrumb-item active">Ghi Chỉ Số Lâm Sàng</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ghi Nhận Chỉ Số Lâm Sàng Của <?php echo $row->pat_fname; ?>
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required="required" readonly name=""
                                                        ...
                                                        class="form-control" id="inputEmail4" placeholder="Tên bệnh nhân">
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" readonly name=""
                                                        ...
                                                        id="inputPassword4" placeholder="Chẩn đoán bệnh">
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" required="required" readonly name="vit_pat_number"
                                                        ...
                                                        id="inputEmail4" placeholder="Mã số bệnh nhân">
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Mã số lâm sàng</label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="inputEmail4" class="col-form-label">Nhiệt độ cơ thể
                                                        (°C)</label>
                                            ...
                                            <button type="submit" name="add_patient_vitals"
                                                class="ladda-button btn btn-success" data-style="expand-right">Thêm chỉ số
                                                lâm sàng</button>
