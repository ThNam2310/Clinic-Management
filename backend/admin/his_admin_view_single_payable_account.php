...
<?php include ('assets/inc/head.php');?>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- ============================================================== -->
            <!-- Bắt đầu nội dung trang tại đây -->
            <!-- ============================================================== -->
            <?php
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Xem tài khoản phải trả</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h4 class="text-danger">Số tiền phải trả: $ <?php echo $row->acc_amount;?> </h4>
                                                    <hr>
