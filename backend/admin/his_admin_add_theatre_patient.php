                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Phẫu thuật | Phòng
                                                mổ</a></li>
                                        <li class="breadcrumb-item active">Chuyển phẫu thuật</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Chuyển phẫu thuật</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <div class="col-12 text-sm-center form-inline">
                                            <div class="form-group mr-2">
                                                <select id="demo-foo-filter-status"
                                                    ...
                                                    <option value="Đã xuất viện">Nội Trú</option>
                                                    <option value="Ngoại trú">Ngoại Trú</option>
                                                    <option value="Nội trú">Xuất viện</option>
                                                </select>
                                            </div>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_admin_theatre_single_patient.php?pat_id=<?php echo $row->pat_id; ?>"
                                                            class="badge badge-primary"><i
                                                                class="mdi mdi-check-box-outline "></i> Chuyển phẫu
                                                            thuật</a>
                                                    </td>
                                                </tr>
                                            <?php $cnt = $cnt + 1;
