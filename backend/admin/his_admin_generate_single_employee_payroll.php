                                ...
                                <div class="col-12">
                                    <div class="card-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    <p class="m-b-10"><strong>Ngày lập : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date("d-m-Y - h:m:s", strtotime($mysqlDateTime));?> </span></p>
                                                    <p class="m-b-10"><strong>Trạng thái bảng lương : </strong> <span class="float-right"><span class="badge badge-success"><?php echo $row->pay_status;?></span></span></p>
                                                    <p class="m-b-10"><strong>Số tiền lương : </strong> <span class="float-right"><?php echo $row->pay_number;?></span></p>
                                                    <p class="m-b-10"><strong>Mã số nhân viên. : </strong> <span class="float-right"><?php echo $row->pay_doc_number;?></span></p>
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive">
                                                    <table class="table mt-4 table-centered table-bordered">
                                                        <thead>
                                                        <tr><th>#</th>
                                                            <th>Phòng ban nhân viên (khoa/phòng)</th>
                                                            <th style="width: 10%">	Lương cơ bản</th>
                                                            <th style="width: 10%">Thuế thu nhập cá nhân (tạm khấu trừ)</th>
                                                            <th style="width: 10%" class="text-right">Số tiền thuế</th>
                                                        </tr></thead>
                                                        <tbody>
                                                        <tr>
                                                            <td><?php echo $cnt;?></td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-right">
                                                    <p><b>Tạm tính:</b> <span class="float-right">$ <?php echo $row->pay_emp_salary;?></span></p>
                                                    <p><b>Thuế thu nhập cá nhân (16%) :</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; <?php echo $taxable_salary;?> </span></p>
                                        ...
                                        <div class="mt-4 mb-1">
                                            <div class="text-right d-print-none">
                                                <a href="javascript:window.print()" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-printer mr-1"></i> In</a>
                                            </div>
                                        </div>
                                    </div> <!-- end card-box -->
                                </div> <!-- end col -->
