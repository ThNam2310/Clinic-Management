                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Thông tin nhân viên y tế</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-sm-center form-inline">
                                            ...
                                            <div class="form-group">
                                                <input id="demo-foo-search" type="text" placeholder="Tìm hiểu"
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_add_single_employee_vitals.php?doc_number=<?php echo $row->doc_number; ?>"
                                                            class="badge badge-success"><i class="fas fa-edit"></i>Ghi nhận
                                                            chỉ số lâm sàng</a></td>
                                                </tr>
