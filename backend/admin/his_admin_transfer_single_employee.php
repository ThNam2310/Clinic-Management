...
if (isset($_POST['trans_dept'])) {
    ...
    if ($stmt) {
        $success = "Đã chuyển nhân viên thành công";
    } else {
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Chuyển khoa nhân viên</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Chuyển nhân viên sang khoa khác</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Mã số nhân viên</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Khoa hiện tại </label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputState" class="col-form-label">Chuyển sang khoa</label>
                                            ...
                                            <button type="submit" name="trans_dept" class="ladda-button btn btn-success" data-style="expand-right">Chuyển khoa</button>
