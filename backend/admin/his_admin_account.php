                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Hồ sơ của <?php echo $row->ad_fname; ?>
                                        <?php echo $row->ad_lname; ?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <p class="text-muted">@Hệ thống quản lý của HMS</p>
                                    <div class="text-left mt-3">
                                        <p class="text-muted mb-2 font-13"><strong>Họ và tên :</strong> <span
                                                class="ml-2"><?php echo $row->ad_fname; ?>
                                                <?php echo $row->ad_lname; ?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span
                                                class="ml-2 "><?php echo $row->ad_email; ?></span></p>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="ad_fname" class="form-control"
                                                                id="firstname" placeholder="<?php echo $row->ad_fname; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="lastname">Tên</label>
                                                            <input type="text" name="ad_lname" class="form-control"
                                                                id="lastname" placeholder="<?php echo $row->ad_lname; ?>">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="ad_email" class="form-control"
                                                                id="useremail" placeholder="<?php echo $row->ad_email; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="useremail">Ảnh hồ sơ</label>
                                                            <input type="file" name="ad_dpic"
                                                                class="form-control btn btn-success" id="useremail"
                                                                placeholder="<?php echo $row->ad_email; ?>">
                                                        </div>
                                                    </div>
                                            ...
                                            <form method="post">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" name="ad_pwd"
                                                                id="lastname" placeholder="Nhập mật khẩu mới">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                                ...
                                                <div class="text-right">
                                                    <button type="submit" name="update_pwd"
                                                        class="btn btn-success waves-effect waves-light mt-2"><i
                                                            class="mdi mdi-content-save"></i> Cập nhật mật khẩu</button>
                                                </div>
                                            </form>
                                        </div>
