<?php
  ...
  if(isset($_GET['delete_vendor_number']))
  {
        ...
        $stmt->close();	 
          ...
          if($stmt)
          {
            $success = "Đã xóa hồ sơ nhà cung cấp";
          }
            else
            {
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Mã số nhà cung cấp</th>
                                                <th data-hide="phone">Email nhà cung cấp</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_view_single_vendor.php?v_number=<?php echo $row->v_number;?>" class="badge badge-success"><i class="fas fa-eye"></i> Xem</a>
                                                        <a href="his_admin_update_single_vendor.php?v_number=<?php echo $row->v_number;?>" class="badge badge-success"><i class="fas fa-edit"></i> Cập nhật</a>
                                                        <a href="his_admin_manage_vendor.php?delete_vendor_number=<?php echo $row->v_number?>" class="badge badge-danger"><i class="fas fa-trash"></i> Xóa hồ sơ</a>
                                                    </td>
                                                </tr>
