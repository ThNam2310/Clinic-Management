...
if (isset($_POST['add_patient_lab_test'])) {
    ...
    if ($stmt) {
        $success = "Đã thêm chỉ định xét nghiệm cận lâm sàng của bệnh nhân thành công.";
    } else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Thêm chỉ định xét nghiệm</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Thêm chỉ định xét nghiệm</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Số phiếu xét nghiệm</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Các xét nghiệm cận lâm
                                                    sàng</label>
                                            ...
                                            <button type="submit" name="add_patient_lab_test"
                                                class="ladda-button btn btn-success" data-style="expand-right">Thêm chỉ định
                                                xét nghiệm</button>
