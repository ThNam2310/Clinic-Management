                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Số Bệnh án</th>
                                                <th data-hide="phone">Địa chỉ Bệnh nhân</th>
                                                <th data-hide="phone">Bệnh của Bệnh nhân</th>
                                        ...
                                        <tbody>
                                            ...
                                            */
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="his_admin_add_single_pres.php?pat_number=<?php echo $row->pat_number; ?>"
                                                        class="badge badge-success"><i class="fas fa-highlighter "></i>
                                                        Thêm đơn thuốc</a></td>
                                            </tr>
                                            <?php $cnt = $cnt + 1;
                                            } ?>
