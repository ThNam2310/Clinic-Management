                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Bệnh nhân nội trú</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Thông tin bệnh nhân nội trú</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <tbody>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                            $ret = "SELECT * FROM  his_patients WHERE pat_type = 'Nội Trú' ORDER BY RAND() ";
