...
if (isset($_POST['add_patient'])) {
    ...
    if ($stmt) {
        $success = "Đã thêm thông tin bệnh nhân thành công";
    } else {
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="inputCity" class="col-form-label">Tình trạng bệnh lý</label>
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                ...
                                                ?>
                                                <label for="inputZip" class="col-form-label">Mã số bệnh nhân
                                                    được</label>
