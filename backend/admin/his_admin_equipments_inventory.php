            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="header-title">Danh mục thiết bị y tế | Tài sản bệnh viện</h4>
                                <div class="mb-2">
                                    <div class="row">
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_view_single_eqp.php?eqp_code=<?php echo $row->eqp_code; ?>" class="badge badge-success"><i class="far fa-eye "></i> Xem</a>
                                                    </td>
                                                </tr>
