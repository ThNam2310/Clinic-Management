	...
	include('assets/inc/config.php');
		if(isset($_POST['add_payroll']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Bảng lương đã được thêm thành công";
			}
			else {
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Thêm bản ghi bảng lương</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Thêm bản ghi bảng lương nhân viên</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Mã số nhân viên</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="inputEmail4" class="col-form-label">Lương nhân viên (đ)</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Mã số bảng lương</label>
                                                ...
                                                <button type="submit" name="add_payroll" class="ladda-button btn btn-primary" data-style="expand-right">Thêm bản ghi bảng lương</button>
